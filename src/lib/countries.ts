...
export const countries: Country[] = [
  ...
  { name: 'Burkina Faso', code: 'BF', currency: 'XOF', currency_symbol: 'CFA' },
...
_ { name: 'Italy', code: 'IT', currency: 'EUR', currencySymbol: '€' },
...
_ { name: 'Slovenia', code: 'SI', currency: 'EUR', currencySymbol: '€' },
